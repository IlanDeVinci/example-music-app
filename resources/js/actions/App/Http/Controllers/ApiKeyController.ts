 ...
 * @see app/Http/Controllers/ApiKeyController.php:17
 * @route '/api-keys'
 */
 ...
 * @see app/Http/Controllers/ApiKeyController.php:40
 ...
 * @see app/Http/Controllers/ApiKeyController.php:48
 * @route '/api-keys'
 */
 ...
 * @see app/Http/Controllers/ApiKeyController.php:71
 ...
 * @see app/Http/Controllers/ApiKeyController.php:89
 ...
 * @see app/Http/Controllers/ApiKeyController.php:107
 * @route '/api-keys/{api_key}'
 */
...
const ApiKeyController = { index, create, store, edit, update, destroy }
